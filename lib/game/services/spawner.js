...
.defines(function(){
	...
	spawnBasicBird = function(){
		...
		this.spawnDelay.basicBird = 180 + Math.random() * 200;
	},

	spawnBasicFloater = function(){
		ig.game.spawnEntity(EntityBasicFloater, Math.random() * ig.system.width, 0);
		this.lastSpawn.basicFloater = ig.game.distanceGenerated;
		this.spawnDelay.basicFloater = 140 + Math.random() * 200;
	}
});