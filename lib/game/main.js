...
MyGame = ig.Game.extend({
	...
	update: function() {
		...
		}else if(!this.paused && ig.input.pressed('begin') && this.player.health <= 0){
	...
	draw: function() {
		...
		if(this.paused){
			...
			if(this.player && this.player.health > 0){
				...
				this.font.draw("- I'm sorry Kudryavka.", ig.system.width/2, ig.system.height/2 - 35, ig.Font.ALIGN.CENTER);
				this.font.draw("You were so brave.", ig.system.width/2, ig.system.height/2 - 15, ig.Font.ALIGN.CENTER);	
			}
		}	
	},
